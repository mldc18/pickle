...
export default function TermsPage() {
  const sections = [
    ...
    { title: "3. Game Registration", text: "Daily game registration is limited to the current admin-set player capacity on a first-come, first-served basis. Players may register until 7:30 PM and may cancel their registration until 7:00 PM on the same day. Failure to show without cancelling will be recorded as a no-show." },
    { title: "4. Waitlist", text: "When all active slots are filled, additional registrants will be placed on a waitlist. If a registered player cancels, the first person on the waitlist will automatically be promoted to the player list." },
