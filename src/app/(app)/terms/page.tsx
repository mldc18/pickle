...
export default function TermsPage() {
  const sections = [
    ...
    { title: "3. Game Registration", text: "Daily game registration opens at 12:00 PM and is limited to 24 players on a first-come, first-served basis. Players may cancel their registration until 7:00 PM on the same day. Failure to show without cancelling will be recorded as a no-show." },
